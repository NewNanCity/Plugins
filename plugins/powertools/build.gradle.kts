...
val pluginName = "PowerTools"
version = "2.0.0"
group = "city.newnan.powertools"
description = "Modern PowerTools plugin with skull utilities"

// 配置插件元数据
tasks.processResources {
    val pluginProperties = createPluginMetadata {
        it.name = pluginName
        it.mainClass = "${project.group}.PowerToolsPlugin"
